...
/**
 * 
 * Problem: iven an integer n, count the total number of digit 1 appearing in
 ...
 * 
 * Solution: Go through the digit positions one at a time, find out how often a
 * "1" appears at each position, and sum those up.
 * 
 ...
 * analyzing the hundreds-digit. And then we know that the hundreds-digit of n
 * is 1 for prefixes "" to "3141", i.e., 3142 times. Each of those times is a
 ...
 * last streak isn't 1000 numbers but only 593 numbers, for the suffixes "000"
 * to "592". So (a / 10 * 1000) + (b + 1) times, the thousands-digit is 1.
 * 
 * The case distinction between the current digit/position being 0, 1 and >=2
 * can easily be done in one expression. With (a + 8) / 10 you get the number of
