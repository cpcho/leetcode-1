 ...
 *
 * Example 1: Input: Height : 5 Width : 7 Tree position : [2,2] Squirrel : [4,4]
 * Nuts : [[3,0], [2,5]] Output: 12
 * 
 * Note: All given positions won't overlap. The squirrel can take at most one
 * nut at one time. The given positions of nuts have no order. Height and width
 * are positive integers. 3 <= height * width <= 10,000. The given positions
 * contain at least one nut, only one tree and one squirrel.
 * 
 */
