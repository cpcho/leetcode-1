 ...
 * undirected graph will be like this: 
 * 
 *   1 
 *  / \ 
 * 2 - 3
 ...
 * 
 * Update (2017-09-26): We have overhauled the problem description + test cases
 * and specified clearly the graph is an undirected graph. For the directed
 * graph follow up please see Redundant Connection II). We apologize for any
