...
/**
 * 
 * Problem: Given a 2D grid, each cell is either a wall 'W', an enemy 'E' or
 * empty '0' (the number zero), return the maximum enemies you can kill using
 * one bomb. The bomb kills all the enemies in the same row and column from the
