...
/**
 * 
 * Problem: Assume you are an awesome parent and want to give your children some
 * cookies. But, you should give each child at most one cookie. Each child i has
 * a greed factor gi, which is the minimum size of a cookie that the child will
 * be content with; and each cookie j has a size sj. If sj >= gi, we can assign
 ...
 *
 * Solution: Just assign the cookies starting from the child with less
 * greediness to maximize the number of happy children.
 * 
 *
 */
